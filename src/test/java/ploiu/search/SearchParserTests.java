...
class SearchParserTests {
    ...
    void testParseHandlesRegularSearch() {
        var input = "test";
        var expected = "test";
    ...
    void testParseStripsExtraSpacesFromSearch() {
        var input = "\ttest      test ";
    ...
    void testParseGetsEntireSearch() {
    ...
    static Stream<Arguments> fullSearchArgs() {
        return Stream.of(
                Arguments.of("blah blah blah +tag1 @size > small +tag2", new Search("blah blah blah", List.of("tag1", "tag2"), List.of(new Attribute("fileSize", EqualityOperator.GT, "small")))),
                Arguments.of("\nblah blah blah +tag1 @size>small  +tag2 blah", new Search("blah blah blah blah", List.of("tag1", "tag2"), List.of(new Attribute("fileSize", EqualityOperator.GT, "small"))))
        );
    }
}
